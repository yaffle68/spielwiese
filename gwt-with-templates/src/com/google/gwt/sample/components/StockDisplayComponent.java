 ...
 */
public class StockDisplayComponent extends Composite {
    private static final int REFRESH_INTERVAL = 5000;

    interface MyUiBinder extends UiBinder<Widget, StockDisplayComponent> {
    }
    ...
    interface Style extends CssResource {
        ...
        String addPanel();
        @CssResource.ClassName("gwt-Button-remove")
    ...
    public StockDisplayComponent(final LoginInfo login) {
        loginInfo = login;
